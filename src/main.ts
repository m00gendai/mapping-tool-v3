...
async function queryTriggerAll(from: string){
  ...
  if(deconstructedOther.length !== 0){
    ...
    else if(results[0][0] === "ERROR" && results[0][1] === "ERROR" && results[0][2] === "ERROR"){
...
const clearTextareas: HTMLButtonElement = document.createElement("button")
...
inputArea.appendChild(clearTextareas)
