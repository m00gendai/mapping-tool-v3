...
export function createDialog(){
  ...
  textElement.innerHTML = `
    ...
    By accepting this, I...
    <ul>
    <li>...am aware that this application is not intended for navigational and/or operational use and only for educational purposes</li>
    <li>...take full responsibility for any concequences resulting from using this application for anything else than its intended educational purpose</li>
